...
<html lang="en">
    ...
    <body>
        ...
        <section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Detail Konser</h2>
                    <ol class="breadcrumb">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">{{ $konser->event }}</h5>
                <p class="card-text"><strong>Artis:</strong> {{ $konser->artis }}</p>
                <p class="card-text"><strong>Venue:</strong> {{ $konser->venue }}</p>
                <p class="card-text"><strong>Date:</strong> {{ $konser->date }}</p>
                <a href="{{ route('konser.index') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
                        <!--================ About History Area  =================-->
