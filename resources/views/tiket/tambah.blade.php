        ...
        <section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Tambah Tiket</h2>
                    <ol class="breadcrumb">
        ...
        <div class="container mt-5">
            ...
            <form method="POST" action="{{ route('tiket.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="availability_status" name="availability_status" required>
                </div>
                <div class="form-group">
                    <label for="konser_id">Konser_id</label>
                    <input type="konser_id" class="form-control" id="konser_id" name="konser_id" required>
                </div>
