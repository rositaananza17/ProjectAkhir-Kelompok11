...
<html lang="en">
    ...
    <body>
        ...
        <section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle"> Tiket</h2>
                    <ol class="breadcrumb">
        ...
        <div class="container mt-5">
            <a href="{{ route('tiket.create') }}" class="btn btn-sm btn-primary mb-3">Tambah</a>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Avalability Status</th> 
                        <th scope="col">Konser_id</th> 
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('tiket.show', $item->id) }}" class="btn btn-info btn-sm">Detail</a>
                            <a href="{{ route('tiket.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
