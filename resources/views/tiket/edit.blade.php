        ...
        <section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Edit Tiket</h2>
                    <ol class="breadcrumb">
        ...
        <div class="container mt-5">
            ...
            <form method="POST" action="{{ route('tiket.update', $tiket->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="price" name="price" value="{{ $tiket->price }}" required>
                </div>
                <div class="form-group">
                    <label for="seat_number">Seat Number</label>
                    <input type="text" class="form-control" id="seat_number" name="seat_number" value="{{ $tiket->seat_number }}" required>
                </div>
                <div class="form-group">
                    <label for="availability_status">Availability Status</label>
                    <input type="text" class="form-control" id="availability_status" name="availability_status" value="{{ $tiket->availability_status }}" required>
                </div>
