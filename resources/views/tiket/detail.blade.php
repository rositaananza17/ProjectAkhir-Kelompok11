...
<html lang="en">
    ...
    <body>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">{{ $tiket->konser_id }}</h5>
                <p class="card-text"><strong>Price:</strong> {{ $tiket->price }}</p>
                <p class="card-text"><strong>Seat Number:</strong> {{ $tiket->seat_number }}</p>
                <p class="card-text"><strong>Availability Status</strong> {{ $tiket->availabilty_status }}</p>
