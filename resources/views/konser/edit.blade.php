        ...
        <section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Edit Konser</h2>
                    <ol class="breadcrumb">
        ...
        <div class="container mt-5">
            ...
            <form method="POST" action="{{ route('konser.update', $konser->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="event" name="event" value="{{ $konser->event }}" required>
                </div>
                <div class="form-group">
                    <label for="artis">Artis</label>
                    <input type="text" class="form-control" id="artis" name="artis" value="{{ $konser->artis }}" required>
                </div>
                <div class="form-group">
                    <label for="venue">Venue</label>
                    <input type="text" class="form-control" id="venue" name="venue" value="{{ $konser->venue }}" required>
                </div>
                <div class="form-group">
                    <label for="date">Date</label>
                    <input type="date" class="form-control" id="date" name="date" value="{{ $konser->date }}" required>
                </div>
